...
#
#     PHX_SERVER=true bin/manavault start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :manavault, ManavaultWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host =
    System.get_env("PHX_HOST") ||
      ...
      It drives the generated URLs and the WebSocket origin check, so a wrong value
      breaks links and live connections.
      """

  config :manavault, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :manavault, Manavault.Mailer,
