...
```sh
docker pull ghcr.io/cfbender/manavault:0.6.8
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.6.8
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.6.8
...
- `0.6.8` and `0.6` from tag `v0.6.8`
- `v0.6.8` from the raw tag ref
