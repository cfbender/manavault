...
```sh
docker pull ghcr.io/cfbender/manavault:0.5.2
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.5.2
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.5.2
...
- `0.5.2` and `0.5` from tag `v0.5.2`
- `v0.5.2` from the raw tag ref
