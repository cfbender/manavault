...
```sh
docker pull ghcr.io/cfbender/manavault:0.7.0
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.7.0
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.7.0
...
- `0.7.0` and `0.7` from tag `v0.7.0`
- `v0.7.0` from the raw tag ref
