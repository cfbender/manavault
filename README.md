...
```sh
docker pull ghcr.io/cfbender/manavault:0.6.7
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.6.7
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.6.7
...
- `0.6.7` and `0.6` from tag `v0.6.7`
- `v0.6.7` from the raw tag ref
