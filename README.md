...
```sh
docker pull ghcr.io/cfbender/manavault:0.5.3
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.5.3
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.5.3
...
- `0.5.3` and `0.5` from tag `v0.5.3`
- `v0.5.3` from the raw tag ref
