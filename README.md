...
```sh
docker pull ghcr.io/cfbender/manavault:0.4.0
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.4.0
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.4.0
...
- `0.4.0` and `0.4` from tag `v0.4.0`
- `v0.4.0` from the raw tag ref
