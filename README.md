...
```sh
docker pull ghcr.io/cfbender/manavault:0.6.5
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.6.5
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.6.5
...
- `0.6.5` and `0.6` from tag `v0.6.5`
- `v0.6.5` from the raw tag ref
