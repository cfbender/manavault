...
```sh
docker pull ghcr.io/cfbender/manavault:0.6.4
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.6.4
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.6.4
...
- `0.6.4` and `0.6` from tag `v0.6.4`
- `v0.6.4` from the raw tag ref
