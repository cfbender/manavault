...
```sh
docker pull ghcr.io/cfbender/manavault:0.6.6
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.6.6
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.6.6
...
- `0.6.6` and `0.6` from tag `v0.6.6`
- `v0.6.6` from the raw tag ref
