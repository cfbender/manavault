...
```sh
docker pull ghcr.io/cfbender/manavault:0.7.1
```
...
docker run -d \
  ...
  ghcr.io/cfbender/manavault:0.7.1
```
...
services:
  manavault:
    image: ghcr.io/cfbender/manavault:0.7.1
...
- `0.7.1` and `0.7` from tag `v0.7.1`
- `v0.7.1` from the raw tag ref
