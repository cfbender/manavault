        ...
        <article className="max-w-[72ch] text-base leading-7 text-base-content/80">
          <Markdown
            ...
            components={{
              ...
              h1: ({ children }) => (
                <h2 className="mb-3 mt-7 text-2xl font-black leading-tight first:mt-0">
                  {children}
                </h2>
              ),
              h2: ({ children }) => (
                <h3 className="mb-2 mt-7 text-xl font-black leading-tight first:mt-0">
                  {children}
                </h3>
              ),
              h3: ({ children }) => (
                <h4 className="mb-2 mt-6 text-base font-black leading-tight first:mt-0">
                  {children}
                </h4>
              ),
