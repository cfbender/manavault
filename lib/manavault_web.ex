defmodule ManavaultWeb do
  ...
  def static_paths,
    do:
      ~w(assets fonts images favicon.ico favicon-16x16.png favicon-32x32.png apple-touch-icon.png site.webmanifest robots.txt)
