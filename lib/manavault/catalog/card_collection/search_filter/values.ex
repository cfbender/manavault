defmodule Manavault.Catalog.CardCollection.SearchFilter.Values do
  @moduledoc false
  ...
  def color_op(:colon), do: :eq
  def color_op(op) when op in [:eq, :neq, :gt, :gte, :lt, :lte], do: op
  def color_op(_op), do: :eq
