defmodule ManavaultWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      phx-mounted={@auto_dismiss && JS.dispatch("manavault:flash-mounted")}
      role="alert"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ManavaultWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ManavaultWeb.Gettext, "errors", msg, opts)
    end
  end
