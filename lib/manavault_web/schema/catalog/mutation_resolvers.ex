defmodule ManavaultWeb.Schema.Catalog.MutationResolvers do
  ...
  defdelegate bulk_update_deck_cards(parent, args, resolution), to: DeckMutations
  defdelegate bulk_delete_deck_cards(parent, args, resolution), to: DeckMutations
  ...
  defdelegate bulk_deallocate_deck_cards(parent, args, resolution), to: AllocationResolvers
