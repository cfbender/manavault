defmodule ManavaultWeb.Schema.CatalogResolvers do
  ...
  defdelegate default_deck_tags(parent, args, resolution), to: QueryResolvers
  ...
  defdelegate bulk_update_deck_cards(parent, args, resolution), to: MutationResolvers
  defdelegate bulk_delete_deck_cards(parent, args, resolution), to: MutationResolvers
  ...
  defdelegate replace_default_deck_tags(parent, args, resolution), to: MutationResolvers
